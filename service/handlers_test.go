...
func TestCreateProject(t *testing.T) {
	tests := []test{
		...
		},
		{
			...
			req:      loadJSON(t, "TestCreateProject/git_repo_must_be_valid_request.json"),
			want:     http.StatusBadRequest,
			respFile: "TestCreateProject/git_repo_must_be_valid_response.json",
			asAdmin:  true,
			url:      "/projects",
			method:   "POST",
		},
		{
			...
			req:      loadJSON(t, "TestCreateProject/project_name_must_be_alphanumeric_request.json"),
			want:     http.StatusBadRequest,
			respFile: "TestCreateProject/project_name_must_be_alphanumeric_response.json",
			asAdmin:  true,
			url:      "/projects",
			method:   "POST",
		},
		{
			...
			req:      loadJSON(t, "TestCreateProject/project_name_cannot_be_less_than_4_characters_request.json"),
			want:     http.StatusBadRequest,
			respFile: "TestCreateProject/project_name_cannot_be_less_than_4_characters_response.json",
			asAdmin:  true,
			url:      "/projects",
			method:   "POST",
		},
		{
			...
			req:      loadJSON(t, "TestCreateProject/project_name_cannot_be_greater_than_32_characters_request.json"),
			want:     http.StatusBadRequest,
			respFile: "TestCreateProject/project_name_cannot_be_greater_than_32_characters_response.json",
			asAdmin:  true,
			url:      "/projects",
			method:   "POST",
		},
...
func TestCreateTarget(t *testing.T) {
	tests := []test{
		...
		},
		{
			...
			req:      loadJSON(t, "TestCreateTarget/name_is_required_request.json"),
			want:     http.StatusBadRequest,
			respFile: "TestCreateTarget/name_is_required_response.json",
			asAdmin:  true,
			url:      "/projects/projectalreadyexists/targets",
			method:   "POST",
		},
		{
			name:     "target name must be alphanumeric underscore",
			req:      loadJSON(t, "TestCreateTarget/target_name_must_be_alphanumeric_underscore_request.json"),
			want:     http.StatusBadRequest,
			respFile: "TestCreateTarget/target_name_must_be_alphanumeric_underscore_response.json",
			asAdmin:  true,
			url:      "/projects/projectalreadyexists/targets",
			method:   "POST",
		},
		{
			...
			req:      loadJSON(t, "TestCreateTarget/target_name_cannot_be_less_than_4_characters_request.json"),
			want:     http.StatusBadRequest,
			respFile: "TestCreateTarget/target_name_cannot_be_less_than_4_characters_response.json",
			asAdmin:  true,
			url:      "/projects/projectalreadyexists/targets",
			method:   "POST",
		},
		{
			...
			req:      loadJSON(t, "TestCreateTarget/target_name_cannot_be_greater_than_32_characters_request.json"),
			want:     http.StatusBadRequest,
			respFile: "TestCreateTarget/target_name_cannot_be_greater_than_32_characters_response.json",
			asAdmin:  true,
			url:      "/projects/projectalreadyexists/targets",
			method:   "POST",
		},
		...
		},
		{
			...
			req:      loadJSON(t, "TestCreateTarget/type_must_be_aws_account_request.json"),
			want:     http.StatusBadRequest,
			respFile: "TestCreateTarget/type_must_be_aws_account_response.json",
			asAdmin:  true,
			url:      "/projects/projectalreadyexists/targets",
			method:   "POST",
		},
		{
			...
			req:      loadJSON(t, "TestCreateTarget/policy_arns_list_length_cannot_be_greater_than_5_request.json"),
			want:     http.StatusBadRequest,
			respFile: "TestCreateTarget/policy_arns_list_length_cannot_be_greater_than_5_response.json",
			asAdmin:  true,
			url:      "/projects/projectalreadyexists/targets",
			method:   "POST",
		},
		{
			...
			req:      loadJSON(t, "TestCreateTarget/policy_arns_are_valid_aws_arns_request.json"),
			want:     http.StatusBadRequest,
			respFile: "TestCreateTarget/policy_arns_are_valid_aws_arns_response.json",
			asAdmin:  true,
			url:      "/projects/projectalreadyexists/targets",
			method:   "POST",
		},
		{
			...
			req:      loadJSON(t, "TestCreateTarget/role_arn_is_valid_aws_arn_request.json"),
			want:     http.StatusBadRequest,
			respFile: "TestCreateTarget/role_arn_is_valid_aws_arn_response.json",
			asAdmin:  true,
			url:      "/projects/projectalreadyexists/targets",
			method:   "POST",
		},
		{
			name:     "credential_type must be valid",
			req:      loadJSON(t, "TestCreateTarget/credential_type_must_be_valid_request.json"),
			want:     http.StatusBadRequest,
			respFile: "TestCreateTarget/credential_type_must_be_valid_response.json",
			asAdmin:  true,
			url:      "/projects/projectalreadyexists/targets",
			method:   "POST",
		},
...
func TestCreateWorkflow(t *testing.T) {
	tests := []test{
		...
		},
		{
			...
			req:      loadJSON(t, "TestCreateWorkflow/execute_container_image_uri_must_be_present_request.json"),
			want:     http.StatusBadRequest,
			respFile: "TestCreateWorkflow/execute_container_image_uri_must_be_present_response.json",
			asAdmin:  true,
			method:   "POST",
			url:      "/workflows",
		},
		{
			...
			req:      loadJSON(t, "TestCreateWorkflow/execute_container_image_uri_must_be_valid_request.json"),
			want:     http.StatusBadRequest,
			respFile: "TestCreateWorkflow/execute_container_image_uri_must_be_valid_response.json",
			asAdmin:  true,
			method:   "POST",
			url:      "/workflows",
		},
