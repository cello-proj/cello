...
func (h handler) checkProject(ctx context.Context, l log.Logger, cp credentials.Provider, w http.ResponseWriter, a credentials.Authorization, projectName string) (bool, error) {
...
func (h handler) createToken(w http.ResponseWriter, r *http.Request) {
	...
	projectExists, err := h.checkProject(ctx, l, cp, w, *a, projectName)
